**Dataset Used:**
This project focuses on predicting heart disease using the Cleveland dataset.
The project uses a version of this dataset provided by Data Professor on GitHub.
The goal was to analyze medical records—like age, cholesterol, and heart rate, to see how they relate to the presence of heart disease.

**Model Used:**
I chose to use a Linear Regression model for this analysis. Even though heart disease is usually a "yes or no" classification but it depends 
upon the dataset you have.
